...
export function Header(props: {
  ...
  const onLogin = async () => {
    ...
    try {
      ...
      setLoggedIn(true)
      setErrorText('')
      reconnect(window.location.origin, loginData.username, loginData.password)
    } catch (e) {
      console.dir(e)
      onLogout()
  ...
  const onLogout = () => {
    logout()
    setLoggedIn(false)
    reconnect(window.location.origin, '', '')
  }
  ...
  return (
    ...
    <div className="header">
      ...
      <div className="avatar" onClick={onAvatarClick}>
        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1000 1000" className="svg">
